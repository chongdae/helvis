...
#define HVERSION "Hangul ELVIS 1.8h2-, by Park Chong-Dae (14 Dec. 1995)"
#define VERSION "ELVIS 1.8pl4, by Steve Kirkendall (27 June 1994)"
#define COPYING	"This version of HELVIS is freely redistributable."
...
extern char	o_hangulinsert[1];
#endif

#ifndef NO_MOUSE
extern char	o_mouse[1];
#endif
...
/*----------------------------------------------------------------------*/
/* These are used to handle Hangul characters				*/

extern int	IsHIdx P_((char *, int));
extern int	FindNCharToMark P_((MARK));
extern int	FindNBytesOfP2CharFromMarkP1 P_((MARK, int));
extern int	FindNBytesOfP2CharBackFromMarkP1 P_((MARK, int));
extern int	AdjunstHLen P_((char *, int));

#define IsHiBitOn(byte)		((byte) & 0x80)
#define IsHiBitOnMark(m)	(IsHiBitOn(ptext[markidx(m)]))

#define AtHangul1(text)		(IsHIdx(ptext,(int)((text)-ptext)) == 1)
#define AtHangul2(text)		(IsHIdx(ptext,(int)((text)-ptext)) == 2)
#define AtASCII(text)		(IsHIdx(ptext,(int)((text)-ptext)) == 0)
