...
/* This tiny program executes helvis with the flags that are appropriate
 * for a given command name.  This program is used only on systems that
 * don't allow UNIX-style file links.
 *
 * The benefit of this program is: instead of having 5 copies of helvis
 * on your disk, you only need one copy of helvis and 4 copies of this
 * little program.
 */
...
#if OSK
#define ELVIS	"/dd/usr/cmds/helvis"
#else
#define ELVIS	"helvis"
#endif
